...
func TestAvg_InstanceAccess(t *testing.T) {
	sentinel.Tag("db")
	sentinel.Tag("type")
	sentinel.Tag("constraints")
...
func TestAvg_MustRender(t *testing.T) {
	sentinel.Tag("db")
	sentinel.Tag("type")
	sentinel.Tag("constraints")
	...
	t.Run("successful MustRender", func(t *testing.T) {
		result := cereal.Avg("age").MustRender()
		if result == nil {
	...
	t.Run("MustRender panics on invalid field", func(t *testing.T) {
		...
		cereal.Avg("nonexistent_field").MustRender()
	})
...
func TestAvg_Validation(t *testing.T) {
	sentinel.Tag("db")
	sentinel.Tag("type")
	sentinel.Tag("constraints")
