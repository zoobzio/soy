...
Cereal provides aggregate functions for counting and computing statistics. All aggregates return `float64` to handle various numeric types uniformly.
...
// Cereal aggregates return single values
```
