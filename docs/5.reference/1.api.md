...
Creates a new cereal instance for the given struct type and table name. Inspects struct tags, builds schema, and caches metadata.
...
| `type` | PostgreSQL type | `type:"text"`, `type:"serial"`, `type:"vector(1536)"` |
